...
; char_atype
			DC.B "wxxxxxxxxxxxxxxxxxxy",CRLF
			DC.B "z A-TYPE {{{{{{{{{{|",CRLF
			DC.B "z{{{{{{{{{{{{{{{{{{|",CRLF
			DC.B "z{{{{{}~~~~~",$7f,"{{{{{{|",CRLF
			DC.B "z{{{{{",$80,"LEVEL",$81,"{{{{{{|",CRLF
			DC.B "z{{{st",$cb,"v",$c9,"v",$c9,"v",$96,"t",$84,"{{{{|",CRLF
			DC.B "z{{{)0:1:2:3:4",$86,"{{{{|",CRLF
			DC.B "z{{{",$1e,$1f,"(",$1f,"(",$1f,"(",$1f,"(",$1f,$8a,"{{{{|",CRLF
			DC.B "z{{{)5:6:7:8:9",$86,"{{{{|",CRLF
			DC.B "z{{{;<=<=<=<=<",$88,"{{{{|",CRLF
			DC.B "z{{{}~~~~~~~~~",$7f,"{{{{|",CRLF
			DC.B "z{{{",$80,"T0P-SC0RE",$81,"{{{{|",CRLF
			DC.B "zst",$cd,"uvvvvvvvvv",$83,"ttt",$84,"|",CRLF
			DC.B "z)1:%%%%%%  %%%%%%",$86,"|",CRLF
			DC.B "z)2:%%%%%%  %%%%%%",$86,"|",CRLF
			DC.B "z)3:%%%%%%  %%%%%%",$86,"|",CRLF
			DC.B "z;<=<<<<<<<<<<<<<<",$88,"|",CRLF
			DC.B $8b,$8c,$8c,$8c,$8c,$8c,$8c,$8c,$8c,$8c,$8c,$8c,$8c,$8c,$8c,$8c,$8c,$8c,$8c,$8d,EOL
