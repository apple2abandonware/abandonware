...
; char_ascore
			DC.B $b3,$b4,$b4,$b4,$b4,$b4,$b5,CRLF
			DC.B $e9,"SC0RE",$ea,CRLF
			DC.B $eb,$ec,$ec,$ec,$ec,$ec,$ed,CRLF
			DC.B "     0 ",CRLF
			DC.B $ee,$bc,$bc,$bc,$bc,$bc,$bc,CRLF
			DC.B $b3,$b4,$b4,$b4,$b4,$b4,$b5,CRLF
			DC.B $b6,"LEVEL",$b7,CRLF
			DC.B $b6,"   0 ",$b7,CRLF
			DC.B $b8,$b9,$b9,$b9,$b9,$b9,$ba,CRLF
			DC.B $b6,"LINES",$b7,CRLF
			DC.B $b6,"   0 ",$b7,CRLF
			DC.B $bb,$bc,$bc,$bc,$bc,$bc,$bd,CRLF
			DC.B $be,$c0,$c1,$c1,$c1,$c1,$c2,CRLF
			DC.B $be,$c3,"    ",$c4,CRLF
			DC.B $be,$c3,"    ",$c4,CRLF
			DC.B $be,$c3,"    ",$c4,CRLF
			DC.B $be,$c3,"    ",$c4,CRLF
			DC.B $be,$c5,$c6,$c6,$c6,$c6,$c7,EOL
