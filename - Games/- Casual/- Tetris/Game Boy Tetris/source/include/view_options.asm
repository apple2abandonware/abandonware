...
; -----------------------------------------------------------------------------
; view.DrawOptionsATypeScreen
; -----------------------------------------------------------------------------
; Inputs: none

view.DrawOptionsATypeScreen SUBROUTINE

                        WRITE_CHAR 0,0
                        INCLUDE "__char_atype.asm"

                        rts


; -----------------------------------------------------------------------------
; view.DrawOptionsBTypeScreen
; -----------------------------------------------------------------------------
; Inputs: none

view.DrawOptionsBTypeScreen SUBROUTINE

                        WRITE_CHAR 0,0
                        INCLUDE "__char_btype.asm"
